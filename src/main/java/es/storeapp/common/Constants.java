...
public class Constants {
    ...
    public static final String AUTH_INVALID_USER_MESSAGE = "auth.invalid.user"; // usuario inválido
    public static final String AUTH_INVALID_PASSWORD_MESSAGE = "auth.invalid.password"; // contraseña inválida
